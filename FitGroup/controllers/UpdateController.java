...
public class UpdateController {
    ...
    public void update (User LoggedUser, int age, int weight) {
    	...
    	boolean result = db.updateUser(LoggedUser);
    	if (result == true){
    	JOptionPane.showMessageDialog(null, "Successfully update information", "InfoBox: " , JOptionPane.INFORMATION_MESSAGE);}
    	else{
        	JOptionPane.showMessageDialog(null, "Fail to update information", "InfoBox: " , JOptionPane.INFORMATION_MESSAGE);
        	LoggedUser.setAge(oldAge);
        	LoggedUser.setWeight(oldWeight);
    	}
